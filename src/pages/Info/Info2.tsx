...
export const Info2 = () => {
  ...
  return (
    <Container>
      <Title>입원절차</Title>
      <ImgContainer>
        <Img src={`${IMGURL}info2_1.svg`} />
        <Img src={`${IMGURL}info2_2.svg`} />
        <Img src={`${IMGURL}info2_3.svg`} />
        <Img src={`${IMGURL}info2_4.svg`} />
      </ImgContainer>
      <TableContainer>
        <Table>
      ...
      <Title>퇴원절차</Title>
      <ImgContainer>
        <Img src={`${IMGURL}info2_5.svg`} />
        <Img src={`${IMGURL}info2_6.svg`} />
        <Img src={`${IMGURL}info2_7.svg`} />
        <Img src={`${IMGURL}info2_8.svg`} />
      </ImgContainer>
      <TableContainer>
        <Table>
